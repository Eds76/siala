...
<Window x:Name="window"
		...
		ResizeMode="NoResize"
        Title="SaveThrow/BAB+AB/AC calculator by Kiryusha, 2023 Siala Edition" Height="820" Width="820">
    <Grid x:Name="main">
    <Rectangle HorizontalAlignment="Left" Height="245" Margin="13,0,0,0" Stroke="Black" VerticalAlignment="Center" Width="538"/>
    <Rectangle HorizontalAlignment="Left" Height="245" Margin="12,10,0,0" Stroke="Black" VerticalAlignment="Top" Width="778"/>
    ...
    <ComboBox x:Name="cmb_class4" HorizontalAlignment="Left" Margin="30,0,0,0" VerticalAlignment="Center" Width="155"/>
    <Slider x:Name="sld_class4" HorizontalAlignment="Left" Margin="199,0,0,0" VerticalAlignment="Center" Width="201" Height="22" SmallChange="1" TickPlacement="BottomRight" AutoToolTipPlacement="BottomRight" IsEnabled="False" IsSnapToTickEnabled="True"/>
    ...
    <TextBox x:Name="tb_WMlvl" HorizontalAlignment="Left" Margin="758,458,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="22" Text="0"/>
    ...
    <TextBox x:Name="tb_class4_f_Copy" HorizontalAlignment="Left" Margin="440,418,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="30" IsEnabled="False" Text="0"/>
    <TextBox x:Name="tb_class4_r_Copy" HorizontalAlignment="Left" Margin="475,418,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="30" IsEnabled="False" Text="0"/>
    <TextBox x:Name="tb_class4_w_Copy" HorizontalAlignment="Left" Margin="510,418,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="30" IsEnabled="False" Text="0"/>
    <TextBox x:Name="tb_class4_r_Copy1" HorizontalAlignment="Left" Margin="475,439,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="30" IsEnabled="False" Text="0"/>
    <TextBox x:Name="tb_class4_r_Copy2" HorizontalAlignment="Left" Margin="475,418,0,0" TextWrapping="Wrap" VerticalAlignment="Top" Width="30" IsEnabled="False" Text="0"/>
...
$ABILITIES = [int]$str,[int]$dex,[int]$con,[int]$wis,[int]$int,[int]$cha
...
function Abilities_CALC
{
	...
	[int]$tb_STR_START.text = [int]$global:start_abilities[0] - 2 * $gnome + 2 * $orc - 2 * $halfling
    [int]$tb_DEX_START.text = [int]$global:start_abilities[1] + 2 * $elf + 2 * $halfling
    [int]$tb_CON_START.text = [int]$global:start_abilities[2] + 2 * $dwarf - 2 * $elf + 2 * $gnome
    [int]$tb_WIS_START.text = [int]$global:start_abilities[3]
    [int]$tb_INT_START.text = [int]$global:start_abilities[4] - 2 * $orc
    [int]$tb_CHA_START.text = [int]$global:start_abilities[5] - 2 * $dwarf - 2 * $orc

	$tb_STR.text = [int]$tb_STR_START.text + [int]$EQUIP12[0].content
    $tb_DEX.text = [int]$tb_DEX_START.text + [int]$EQUIP12[1].content
    $tb_CON.text = [int]$tb_CON_START.text + [int]$EQUIP12[2].content
    $tb_WIS.text = [int]$tb_WIS_START.text + [int]$EQUIP12[3].content
    $tb_INT.text = [int]$tb_INT_START.text + [int]$EQUIP12[4].content
    $tb_CHA.text = [int]$tb_CHA_START.text + [int]$EQUIP12[5].content
}
    ...
    $BTN_PLUSES[$count].add_Click({
        if($global:start_abilities[$count] -in 8..17)
        {
            ...
            switch ($global:start_abilities[$count])
            {
           	...
           	#$global:start_abilities[$count] = $__costStat
			$ABILITIES[$count] = $__costStat
            $tb_ABILITY_POINTS.text = 30 - $ABILITIES[0] - $ABILITIES[1] - $ABILITIES[2] - $ABILITIES[3] - $ABILITIES[4] - $ABILITIES[5]
            #$ABILITIES_TB[$count].text = $TB_START[$count].text
            Abilities_CALC
        }
    }.GetNewClosure())
