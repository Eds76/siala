...
<Window x:Name="window"
        ...
        <TabControl>
            ...
            <TabItem Header="Feats 1-20">
                <Grid x:Name="tab_feats" Background="#FFE5E5E5">
                    <ComboBox x:Name="cmb_class_01" HorizontalAlignment="Left" Margin="10,84,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01" HorizontalAlignment="Left" Margin="187,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01" HorizontalAlignment="Left" Margin="392,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01" HorizontalAlignment="Left" Margin="597,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy" HorizontalAlignment="Left" Margin="10,111,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy" HorizontalAlignment="Left" Margin="187,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy" HorizontalAlignment="Left" Margin="392,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy" HorizontalAlignment="Left" Margin="597,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy1" HorizontalAlignment="Left" Margin="10,138,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy1" HorizontalAlignment="Left" Margin="187,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy1" HorizontalAlignment="Left" Margin="392,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy1" HorizontalAlignment="Left" Margin="597,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy2" HorizontalAlignment="Left" Margin="10,165,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy2" HorizontalAlignment="Left" Margin="187,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy2" HorizontalAlignment="Left" Margin="392,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy2" HorizontalAlignment="Left" Margin="597,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy3" HorizontalAlignment="Left" Margin="10,192,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy3" HorizontalAlignment="Left" Margin="187,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy3" HorizontalAlignment="Left" Margin="392,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy3" HorizontalAlignment="Left" Margin="597,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy4" HorizontalAlignment="Left" Margin="10,219,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy4" HorizontalAlignment="Left" Margin="187,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy4" HorizontalAlignment="Left" Margin="392,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy4" HorizontalAlignment="Left" Margin="597,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy5" HorizontalAlignment="Left" Margin="10,246,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy5" HorizontalAlignment="Left" Margin="187,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy5" HorizontalAlignment="Left" Margin="392,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy5" HorizontalAlignment="Left" Margin="597,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy6" HorizontalAlignment="Left" Margin="10,273,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy6" HorizontalAlignment="Left" Margin="187,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy6" HorizontalAlignment="Left" Margin="392,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy6" HorizontalAlignment="Left" Margin="597,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy7" HorizontalAlignment="Left" Margin="10,300,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy7" HorizontalAlignment="Left" Margin="187,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy7" HorizontalAlignment="Left" Margin="392,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy7" HorizontalAlignment="Left" Margin="597,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy8" HorizontalAlignment="Left" Margin="10,327,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy8" HorizontalAlignment="Left" Margin="187,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy8" HorizontalAlignment="Left" Margin="392,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy8" HorizontalAlignment="Left" Margin="597,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy9" HorizontalAlignment="Left" Margin="10,379,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy9" HorizontalAlignment="Left" Margin="187,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy9" HorizontalAlignment="Left" Margin="392,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy9" HorizontalAlignment="Left" Margin="597,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy10" HorizontalAlignment="Left" Margin="10,405,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy10" HorizontalAlignment="Left" Margin="187,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy10" HorizontalAlignment="Left" Margin="392,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy10" HorizontalAlignment="Left" Margin="597,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy11" HorizontalAlignment="Left" Margin="10,433,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy11" HorizontalAlignment="Left" Margin="187,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy11" HorizontalAlignment="Left" Margin="392,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy11" HorizontalAlignment="Left" Margin="597,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy12" HorizontalAlignment="Left" Margin="10,459,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy12" HorizontalAlignment="Left" Margin="187,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy12" HorizontalAlignment="Left" Margin="392,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy12" HorizontalAlignment="Left" Margin="597,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy13" HorizontalAlignment="Left" Margin="10,487,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy13" HorizontalAlignment="Left" Margin="187,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy13" HorizontalAlignment="Left" Margin="392,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy13" HorizontalAlignment="Left" Margin="597,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy14" HorizontalAlignment="Left" Margin="10,514,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy14" HorizontalAlignment="Left" Margin="187,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy14" HorizontalAlignment="Left" Margin="392,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy14" HorizontalAlignment="Left" Margin="597,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy15" HorizontalAlignment="Left" Margin="10,541,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy15" HorizontalAlignment="Left" Margin="187,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy15" HorizontalAlignment="Left" Margin="392,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy15" HorizontalAlignment="Left" Margin="597,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy16" HorizontalAlignment="Left" Margin="10,568,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy16" HorizontalAlignment="Left" Margin="187,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy16" HorizontalAlignment="Left" Margin="392,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy16" HorizontalAlignment="Left" Margin="597,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy17" HorizontalAlignment="Left" Margin="10,595,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy17" HorizontalAlignment="Left" Margin="187,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy17" HorizontalAlignment="Left" Margin="392,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy17" HorizontalAlignment="Left" Margin="597,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy18" HorizontalAlignment="Left" Margin="10,622,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy18" HorizontalAlignment="Left" Margin="187,622,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy18" HorizontalAlignment="Left" Margin="392,622,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy18" HorizontalAlignment="Left" Margin="597,622,0,0" VerticalAlignment="Top" Width="200"/>
                </Grid>
            </TabItem>

            <TabItem Header="Feats 21-41">
                <Grid x:Name="tab_feats2" Background="#FFE5E5E5">
                    <ComboBox x:Name="cmb_class_01_Copy19" HorizontalAlignment="Left" Margin="10,84,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy19" HorizontalAlignment="Left" Margin="187,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy19" HorizontalAlignment="Left" Margin="392,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy19" HorizontalAlignment="Left" Margin="597,84,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy20" HorizontalAlignment="Left" Margin="10,111,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy20" HorizontalAlignment="Left" Margin="187,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy20" HorizontalAlignment="Left" Margin="392,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy20" HorizontalAlignment="Left" Margin="597,111,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy21" HorizontalAlignment="Left" Margin="10,138,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy21" HorizontalAlignment="Left" Margin="187,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy21" HorizontalAlignment="Left" Margin="392,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy21" HorizontalAlignment="Left" Margin="597,138,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy22" HorizontalAlignment="Left" Margin="10,165,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy22" HorizontalAlignment="Left" Margin="187,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy22" HorizontalAlignment="Left" Margin="392,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy22" HorizontalAlignment="Left" Margin="597,165,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy23" HorizontalAlignment="Left" Margin="10,192,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy23" HorizontalAlignment="Left" Margin="187,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy23" HorizontalAlignment="Left" Margin="392,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy23" HorizontalAlignment="Left" Margin="597,192,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy24" HorizontalAlignment="Left" Margin="10,219,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy24" HorizontalAlignment="Left" Margin="187,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy24" HorizontalAlignment="Left" Margin="392,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy24" HorizontalAlignment="Left" Margin="597,219,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy25" HorizontalAlignment="Left" Margin="10,246,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy25" HorizontalAlignment="Left" Margin="187,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy25" HorizontalAlignment="Left" Margin="392,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy25" HorizontalAlignment="Left" Margin="597,246,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy26" HorizontalAlignment="Left" Margin="10,273,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy26" HorizontalAlignment="Left" Margin="187,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy26" HorizontalAlignment="Left" Margin="392,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy26" HorizontalAlignment="Left" Margin="597,273,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy27" HorizontalAlignment="Left" Margin="10,300,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy27" HorizontalAlignment="Left" Margin="187,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy27" HorizontalAlignment="Left" Margin="392,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy27" HorizontalAlignment="Left" Margin="597,300,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy28" HorizontalAlignment="Left" Margin="10,327,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy28" HorizontalAlignment="Left" Margin="187,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy28" HorizontalAlignment="Left" Margin="392,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy28" HorizontalAlignment="Left" Margin="597,327,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy29" HorizontalAlignment="Left" Margin="10,379,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy29" HorizontalAlignment="Left" Margin="187,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy29" HorizontalAlignment="Left" Margin="392,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy29" HorizontalAlignment="Left" Margin="597,379,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy30" HorizontalAlignment="Left" Margin="10,405,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy30" HorizontalAlignment="Left" Margin="187,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy30" HorizontalAlignment="Left" Margin="392,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy30" HorizontalAlignment="Left" Margin="597,405,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy31" HorizontalAlignment="Left" Margin="10,433,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy31" HorizontalAlignment="Left" Margin="187,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy31" HorizontalAlignment="Left" Margin="392,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy31" HorizontalAlignment="Left" Margin="597,433,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy32" HorizontalAlignment="Left" Margin="10,459,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy32" HorizontalAlignment="Left" Margin="187,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy32" HorizontalAlignment="Left" Margin="392,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy32" HorizontalAlignment="Left" Margin="597,459,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy33" HorizontalAlignment="Left" Margin="10,487,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy33" HorizontalAlignment="Left" Margin="187,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy33" HorizontalAlignment="Left" Margin="392,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy33" HorizontalAlignment="Left" Margin="597,487,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy34" HorizontalAlignment="Left" Margin="10,514,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy34" HorizontalAlignment="Left" Margin="187,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy34" HorizontalAlignment="Left" Margin="392,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy34" HorizontalAlignment="Left" Margin="597,514,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy35" HorizontalAlignment="Left" Margin="10,541,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy35" HorizontalAlignment="Left" Margin="187,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy35" HorizontalAlignment="Left" Margin="392,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy35" HorizontalAlignment="Left" Margin="597,541,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy36" HorizontalAlignment="Left" Margin="10,568,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy36" HorizontalAlignment="Left" Margin="187,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy36" HorizontalAlignment="Left" Margin="392,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy36" HorizontalAlignment="Left" Margin="597,568,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy37" HorizontalAlignment="Left" Margin="10,595,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy37" HorizontalAlignment="Left" Margin="187,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy37" HorizontalAlignment="Left" Margin="392,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy37" HorizontalAlignment="Left" Margin="597,595,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_class_01_Copy38" HorizontalAlignment="Left" Margin="10,622,0,0" VerticalAlignment="Top" Width="150"/>
                    <ComboBox x:Name="cmb_feat1_01_Copy38" HorizontalAlignment="Left" Margin="187,622,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat2_01_Copy38" HorizontalAlignment="Left" Margin="392,622,0,0" VerticalAlignment="Top" Width="200"/>
                    <ComboBox x:Name="cmb_feat3_01_Copy38" HorizontalAlignment="Left" Margin="597,622,0,0" VerticalAlignment="Top" Width="200"/>
                </Grid>
            </TabItem>
...
#####feats
$feats = @(
	[pscustomobject]@{name="Автоматически неподвижное заклинание"}
	[pscustomobject]@{name="Автоматически тихое заклинание"}
	[pscustomobject]@{name="Автоматически ускоренное заклинание"}
	[pscustomobject]@{name="Артист"}
	[pscustomobject]@{name="Атака с ходу"}
	[pscustomobject]@{name="Бдительность"}
	[pscustomobject]@{name="Боевое чтение заклинаний"}
	[pscustomobject]@{name="Божественная мощь"}
	[pscustomobject]@{name="Божественное здоровье"}
	[pscustomobject]@{name="Божественный щит"}
	[pscustomobject]@{name="Бой вслепую"}
	[pscustomobject]@{name="Бой двумя видами оружия"}
	[pscustomobject]@{name="Болван"}
	[pscustomobject]@{name="Большая фокусировка на школе магии"}
	[pscustomobject]@{name="Большое проникающее заклинание"}
	[pscustomobject]@{name="Бронированная кожа"}
	[pscustomobject]@{name="Быстрая перезарядка"}
	[pscustomobject]@{name="Быстрое передвижение варвара"}
	[pscustomobject]@{name="Быстрый выстрел"}
	[pscustomobject]@{name="Великая ловкость"}
	[pscustomobject]@{name="Великая мудрость"}
	[pscustomobject]@{name="Великая сила"}
	[pscustomobject]@{name="Великая стойкость"}
	[pscustomobject]@{name="Великая харизма"}
	[pscustomobject]@{name="Великий интеллект"}
	[pscustomobject]@{name="Великое разрубание"}
	[pscustomobject]@{name="Великое телосложение"}
	[pscustomobject]@{name="Владение простым оружием"}
	[pscustomobject]@{name="Владение щитом"}
	[pscustomobject]@{name="Вражья смерть"}
	[pscustomobject]@{name="Вызвать фамильяра"}
	[pscustomobject]@{name="Главный враг"}
	[pscustomobject]@{name="Головорез"}
	[pscustomobject]@{name="Громоподобная ярость"}
	[pscustomobject]@{name="Грязный поединок"}
	[pscustomobject]@{name="Дзен стрельба"}
	[pscustomobject]@{name="Длительное воодушевление"}
	[pscustomobject]@{name="Дополнительная музыка"}
	[pscustomobject]@{name="Дополнительное изгнание"}
	[pscustomobject]@{name="Дополнительные оглушающие атаки"}
	[pscustomobject]@{name="Дополнительные попытки сразить зло или добро"}
	[pscustomobject]@{name="Дух сиалы"}
	[pscustomobject]@{name="Железная воля"}
	[pscustomobject]@{name="Животное компаньон"}
	[pscustomobject]@{name="Защитная уловка"}
	[pscustomobject]@{name="Змеиная кровь"}
	[pscustomobject]@{name="Знания бардов"}
	[pscustomobject]@{name="Идеальное здоровье"}
	[pscustomobject]@{name="Изгнание планаров"}
	[pscustomobject]@{name="Изгнать нежить"}
	[pscustomobject]@{name="Калечащий удар"}
	[pscustomobject]@{name="Кипящая кровь"}
	[pscustomobject]@{name="Лечащая рука"}
	[pscustomobject]@{name="Ловкое владение оружием"}
	[pscustomobject]@{name="Магократическое воспитание"}
	[pscustomobject]@{name="Максимизированное заклинание"}
	[pscustomobject]@{name="Маскировка"}
	[pscustomobject]@{name="Мастерские навыки"}
	[pscustomobject]@{name="Мастерство"}
	[pscustomobject]@{name="Мобильность"}
	[pscustomobject]@{name="Могучая ярость"}
	[pscustomobject]@{name="Молниеносная реакция"}
	[pscustomobject]@{name="Мощная атака"}
	[pscustomobject]@{name="Не оставляющий следов шаг"}
	[pscustomobject]@{name="Неподвижное заклинание"}
	[pscustomobject]@{name="Неумолкающая песня"}
	[pscustomobject]@{name="Ношение брони (легкая)"}
	[pscustomobject]@{name="Ношение брони (средняя)"}
	[pscustomobject]@{name="Ношение брони (тяжелая)"}
	[pscustomobject]@{name="Оглушающий кулак"}
	[pscustomobject]@{name="Одинаковое владение обеими руками"}
	[pscustomobject]@{name="Оппортунист"}
	[pscustomobject]@{name="Оружейная специализация"}
	[pscustomobject]@{name="Ослепительная скорость"}
	[pscustomobject]@{name="Отражение стрел"}
	[pscustomobject]@{name="Песня барда"}
	[pscustomobject]@{name="Превосходная инициатива"}
	[pscustomobject]@{name="Превосходный критический удар"}
	[pscustomobject]@{name="Природное чутье"}
	[pscustomobject]@{name="Прицельный выстрел"}
	[pscustomobject]@{name="Проклинающая песня"}
	[pscustomobject]@{name="Проникающее заклинание"}
	[pscustomobject]@{name="Разоружение"}
	[pscustomobject]@{name="Разрубание"}
	[pscustomobject]@{name="Разрушительный критический удар"}
	[pscustomobject]@{name="Сбивание с ног"}
	[pscustomobject]@{name="Сварить зелье"}
	[pscustomobject]@{name="Серебряная ладонь"}
	[pscustomobject]@{name="Сильный дух"}
	[pscustomobject]@{name="Скользкий ум"}
	[pscustomobject]@{name="Скрытая атака"}
	[pscustomobject]@{name="Скрытность"}
	[pscustomobject]@{name="Создать волшебную палочку"}
	[pscustomobject]@{name="Создать свиток"}
	[pscustomobject]@{name="Сопротивление болезни"}
	[pscustomobject]@{name="Сопротивление энергии"}
	[pscustomobject]@{name="Сопротивление яду"}
	[pscustomobject]@{name="Стрельба вупор"}
	[pscustomobject]@{name="Тайная защита"}
	[pscustomobject]@{name="Тихое заклинание"}
	[pscustomobject]@{name="Увертливость"}
	[pscustomobject]@{name="Удар по кругу"}
	[pscustomobject]@{name="Удача героев"}
	[pscustomobject]@{name="Удлиненное заклинание"}
	[pscustomobject]@{name="Ужасная ярость"}
	[pscustomobject]@{name="Уклонение"}
	[pscustomobject]@{name="Улучшенная инициатива"}
	[pscustomobject]@{name="Улучшенная мощная атака"}
	[pscustomobject]@{name="Улучшенная скрытая атака"}
	[pscustomobject]@{name="Улучшенная ураганная атака"}
	[pscustomobject]@{name="Улучшенное боевое чтение заклинаний"}
	[pscustomobject]@{name="Улучшенное мастерство"}
	[pscustomobject]@{name="Улучшенное парирование"}
	[pscustomobject]@{name="Улучшенное разоружение"}
	[pscustomobject]@{name="Улучшенное сбивание с ног"}
	[pscustomobject]@{name="Улучшенное сопротивление заклинаниям"}
	[pscustomobject]@{name="Улучшенное уклонение"}
	[pscustomobject]@{name="Улучшенный безоружный удар"}
	[pscustomobject]@{name="Улучшенный бой двумя видами оружия"}
	[pscustomobject]@{name="Улучшенный критический удар"}
	[pscustomobject]@{name="Улучшенный оглушающий кулак"}
	[pscustomobject]@{name="Улучшенный удар ки"}
	[pscustomobject]@{name="Ураганная атака"}
	[pscustomobject]@{name="Усиленное заклинание"}
	[pscustomobject]@{name="Ускоренное заклинание"}
	[pscustomobject]@{name="Фокусировка на навыке"}
	[pscustomobject]@{name="Фокусировка на оружии"}
	[pscustomobject]@{name="Фокусировка на школе магии"}
	[pscustomobject]@{name="Форма аутсайдера"}
	[pscustomobject]@{name="Форма дракона"}
	[pscustomobject]@{name="Форма конструкта"}
	[pscustomobject]@{name="Форма нежити"}
	[pscustomobject]@{name="Шквал ударов"}
	[pscustomobject]@{name="Эпическая воля"}
	[pscustomobject]@{name="Эпическая доблесть"}
	[pscustomobject]@{name="Эпическая живучесть"}
	[pscustomobject]@{name="Эпическая оружейная специализация"}
	[pscustomobject]@{name="Эпическая реакция"}
	[pscustomobject]@{name="Эпическая репутация"}
	[pscustomobject]@{name="Эпическая стойкость"}
	[pscustomobject]@{name="Эпическая увертливость"}
	[pscustomobject]@{name="Эпическая фокусировка на навыке"}
	[pscustomobject]@{name="Эпическая фокусировка на оружии"}
	[pscustomobject]@{name="Эпическая фокусировка на школе магии"}
	[pscustomobject]@{name="Эпический дьявольский слуга"}
	[pscustomobject]@{name="Эпический теневой лорд"}
	[pscustomobject]@{name="Эпическое заклинание"}
	[pscustomobject]@{name="Эпическое проникающее заклинание"}
	[pscustomobject]@{name="Эпическое сопротивление энергии"}
	[pscustomobject]@{name="Эпическое уменьшение повреждений"}
	[pscustomobject]@{name="Ярость варвара"}
)
...
foreach($__item in $tab1.children)
{
	if($__item.IsEnabled)
	{
		...
		{
			$__item.Add_TextChanged({ SldCMb_calculation; checkbox_calculation }.GetNewClosure())
		}
		if($__item.gettype().name -eq "CheckBox")
		{
			$__item.Add_click({ SldCMb_calculation;	checkbox_calculation }.GetNewClosure())
		}
		if($__item.gettype().name -eq "ComboBox")
		{
			$__item.add_SelectionChanged({ SldCMb_calculation; checkbox_calculation }.GetNewClosure())
		}
		if($__item.gettype().name -eq "Slider")
		{
			$__item.add_valuechanged({ SldCMb_calculation; checkbox_calculation; }.GetNewClosure())
		}
	}
}
...
#========================#
#==========================save and load===================
function Save-File([string] $initialDirectory,$__FileName)
{
    [System.Reflection.Assembly]::LoadWithPartialName("System.windows.forms") | Out-Null
    $OpenFileDialog = New-Object System.Windows.Forms.SaveFileDialog
    $OpenFileDialog.initialDirectory = $initialDirectory
	$OpenFileDialog.FileName = $__FileName
...
$btn_Save.add_Click({
	...
	for($__count = 0; $__count -lt 4; $__count++)
	{
		if($comboboxes_CR[$__count].selectedvalue -ne "<none>")
		{
			$global:__FileName += "$($comboboxes_CR[$__count].selectedvalue)"+"$($textboxes_CR[$__count].text)"
		}
	}
	...
	foreach($__item in $tab1.children)
		{
			...
			#{
                ...
                #$global:__all_vars += $global:start_abilities
			#}
		}
	$SaveFile=Save-File "\" $global:__FileName
	if ($SaveFile -ne "") 
	{
	...
	$varType = "TextBox","CheckBox","ComboBox","Slider","Button"
	$global:__all_vars | sort name | ? {$_.gettype().name -in $varType} | select name,text,isChecked,selecteditem,value,content | Export-Csv $SaveFile -Encoding utf8 -force -NoTypeInformation
    #$data | ForEach-Object {"Item: [$PSItem]"}
    $save_start_abilities = $global:start_abilities | ForEach-Object { [PSCustomObject]@{'Name' = "Start_Ab";'Value' = $_ } }
    $save_start_abilities | Export-Csv $SaveFile -Encoding utf8 -force -NoTypeInformation -Append
    #$global:start_abilities | ForEach-Object {"Item: [$_]"} | Export-Csv $SaveFile -Encoding utf8 -force -NoTypeInformation -Append
    $global:__all_vars = @()
...
$btn_Load.add_Click({
	...
	foreach($loadItem in $global:__loadVars)
		{
            if( ($loadItem -ne "") -AND ($loadItem.name -ne "Start_Ab") )
            {
                #$__object = ($global:__all_vars).Where({$_.name -eq $loadItem.name})
                $Start_AB = $global:__loadVars | where {$_.name -eq "start_ab"} | select name,value
                for($__count = 0; $__count -lt 6; $__count++)
                {
                    $global:start_abilities[$__count] = $Start_AB[$__count].value
                }
                ...
                switch( $__object.gettype().name )
                {
                    ...
                    ComboBox 
                    {
                        ...
                        $__object.text = $loadItem.selecteditem
                    }
                    Slider 
                    {
                    ...
                    Button
                    {
                        $__object.Content = $loadItem.Content
                    }
                }
            }
		}
...
#===========FEATS 1-21 =============#
foreach($__comboBoxClass in $tab_feats.children)
{
    if($__comboBoxClass.name -like "*class*")
    {
        foreach($__item in $comboboxes_CR)
        {
            $__item.add_SelectionChanged({
                    $__cmb_selecteditems = ($comboboxes_CR | where {$_.selecteditem -ne "<none>"}).selecteditem
                    $__comboBoxClass.Items.clear() | Out-Null
                    $__cmb_selecteditems | foreach {
                        $__comboBoxClass.Items.Add($_)
                        $__comboBoxClass.SelectedIndex = 0
                    } | Out-Null
...
foreach($__item in $tab_feats.children)
{
    if($__item.name -like "*feat*")
    {
		$__item.Items.Add("<none>") | Out-Null
        $feats.name | foreach {
            $__item.Items.Add($_)
...
#===========FEATS 21-41 =============#
foreach($__comboBoxClass in $tab_feats2.children)
{
    if($__comboBoxClass.name -like "*class*")
    {
        foreach($__item in $comboboxes_CR)
...
foreach($__item in $tab_feats2.children)
{
    if($__item.name -like "*feat*")
    {
		$__item.Items.Add("<none>") | Out-Null
